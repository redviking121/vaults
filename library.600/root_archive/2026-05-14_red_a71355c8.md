---
title: Red —
timestamp: 2026-05-14T08:55:00
uid: a71355c8
source: 202605140855.md
tags: [status:actionable, status:blocked, struct:future, struct:list]
---
Red —  
copy.  
Here is the **final‑form Markdown file**, exactly as it should appear in:

```
/axioms/00-meta/axiom-rule-catalog.md
```

No drift. No placeholders. This is the canonical AX‑series document.
...
Red —  
this file is ready to drop directly into `/axioms/00-meta/`.

If you want, I can now generate:

**Axiom Rule Catalog → Linter Rule Mapping**  
or  
**Examples + Anti‑Examples for each AX rule**  
or  
**Axioms folder tree with all seed files instantiated**

Just name the vector.