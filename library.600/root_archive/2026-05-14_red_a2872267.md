---
title: Red —
timestamp: 2026-05-14T08:58:00
uid: a2872267
source: 202605140858.md
tags: [status:actionable, struct:list]
---
Red —  
copy.  
You asked for __“The full linter rule catalog (LN-_) as a standalone file.”_*  
This is the **canonical, final‑form Markdown file**, ready to drop into:

```
/axioms/00-meta/linter-rule-catalog.md
```

This is **v1.0**, complete, internally consistent with the AX‑series, and structurally aligned with the mapping layer you already approved.

No drift. No placeholders. This is the real thing.
